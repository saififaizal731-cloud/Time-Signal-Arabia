...
const products = [
  ...
  },
  {
    ...
    featured: true,
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=500&h=400&fit=crop',
    images: ['https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=500&h=400&fit=crop']
  },
  {
    ...
    featured: false,
    rating: 4.6,
    image: 'https://images.unsplash.com/photo-1596532686361-deb13135a00f?w=500&h=400&fit=crop',
    images: ['https://images.unsplash.com/photo-1596532686361-deb13135a00f?w=500&h=400&fit=crop']
  },
  {
    ...
    featured: true,
    rating: 4.7,
    image: 'https://images.unsplash.com/photo-1604357209793-fca5dca89f97?w=500&h=400&fit=crop',
    images: ['https://images.unsplash.com/photo-1604357209793-fca5dca89f97?w=500&h=400&fit=crop']
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=500&h=400&fit=crop']
  },
  {
...
async function seedProducts() {
  try {
    ...
    console.log(`✓ Successfully added ${inserted.length} products with REAL images!`);

    console.log('\n--- Products with Real Images ---');
    products.forEach((p, i) => {
      console.log(`${i + 1}. ${p.name}`);
      console.log(`   Price: ${p.price} SAR | Stock: ${p.stock}`);
      console.log(`   Image: ✓ Real image loaded`);
    });
